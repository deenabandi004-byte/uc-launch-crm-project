  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 4 }}>
        ...
        {contact.linkedinUrl && (
          <a href={contact.linkedinUrl.startsWith("http") ? contact.linkedinUrl : `https://${contact.linkedinUrl}`} target="_blank" rel="noopener noreferrer" style={{ borderRadius: 3, padding: 2, color: "#94A3B8", transition: "color 0.15s" }}
            onMouseEnter={(e) => { e.currentTarget.style.color = "#7C3AED"; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = "#94A3B8"; }}
          >
            <Linkedin size={12} />
